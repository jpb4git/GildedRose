...
public class GildedRoseRefactorTest {
    ...
    @Test
    void decrease_Regular_Name_Sellin_All_Day() {
    ...
    @Test
    void decrease_Regular_Name_Quality_All_Day() {
        Item[] items = new Item[] { new Item("foo", 10, 10) };
        GildedRoseRefactor app = new GildedRoseRefactor(items);
        app.updateQuality();
    ...
    @Test
    void date_Has_Passed_Quality_Degrade_Twice() {
    ...
    @Test
    void date_Has_Passed_And_Quality_Never_Negativ() {
    ...
    @Test
    void Quality_Never_Greater_Than_50_Backstage_Passes() {
